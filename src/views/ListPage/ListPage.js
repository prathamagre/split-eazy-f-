...
// const NavigatePayment = (listingID, description, category, participants) => {
...
//                         <button onClick={()=>NavigatePayment(listing.listingID,listing.description,listing.name, listing.participants)}>Open</button>
//                     </div>
//                 ))}
//             </div>
//         </div>
